...
export default function Home() {
  ...
  return (
    <main className="page-wrapper">
        ...
        <div className="main-container relative md:mx-[200px] md:mb-[200px] -mt-[200px] mx-[8vw] rounded-xl px-6 py-24 md:py-24 md:px-36 bg-dark-gray text-center z-10 overflow-hidden text-body font-medium">
          ...
          <div className="product-tabs text-label md:text-body text-text flex gap-4 items-center justify-center my-8">
